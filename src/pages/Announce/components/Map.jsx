...
function Map({ data, setData: setLocation }) {
  ...
  const [canDeliver, setCanDeliver] = useState(data.has_delivery);
  ...
  const demoAddresses = [
    ...
    {
      name: "Ташкент, улица Батыра Закирова, 7",
      lat: 41.326418,
      lon: 69.228431,
    },
    ...
    {
      name: "Ташкент, Мирабадский район, проспект Амира Темура, 19",
      lat: 41.308254,
      lon: 69.282455,
    },
    {
      name: "Узбекистан, Ташкент, Яшнабадский район, улица Шахрисабз, 87",
      lat: 41.275547,
      lon: 69.203496,
    },
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none z-10">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                <path
                  d="M20 0C13.373 0 8 5.373 8 12c0 9 12 20 12 20s12-11 12-20c0-6.627-5.373-12-12-12z"
                  fill="#FF0000"
                />
